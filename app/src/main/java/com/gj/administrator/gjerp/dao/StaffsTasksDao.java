...
/** 
 * DAO for table "STAFFS_TASKS".
*/
public class StaffsTasksDao extends AbstractDao<StaffsTasks, Long> {

    public static final String TABLENAME = "STAFFS_TASKS";

    /**
     * Properties of entity StaffsTasks.<br/>
     * Can be used for QueryBuilder and for referencing column names.
    */
    public static class Properties {
        public final static Property Id = new Property(0, Long.class, "id", true, "_id");
        public final static Property Staff_id = new Property(1, long.class, "staff_id", false, "STAFF_ID");
        public final static Property Task_id = new Property(2, long.class, "task_id", false, "TASK_ID");
    };

    private DaoSession daoSession;


    public StaffsTasksDao(DaoConfig config) {
        super(config);
    }
    
    public StaffsTasksDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"STAFFS_TASKS\" (" + //
                "\"_id\" INTEGER PRIMARY KEY AUTOINCREMENT ," + // 0: id
                "\"STAFF_ID\" INTEGER NOT NULL ," + // 1: staff_id
                "\"TASK_ID\" INTEGER NOT NULL );"); // 2: task_id
    }

    /** Drops the underlying database table. */
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"STAFFS_TASKS\"";
        db.execSQL(sql);
    }
    ...
    /** @inheritdoc */
    @Override
    public StaffsTasks readEntity(Cursor cursor, int offset) {
        StaffsTasks entity = new StaffsTasks( //
            cursor.isNull(offset + 0) ? null : cursor.getLong(offset + 0), // id
            cursor.getLong(offset + 1), // staff_id
            cursor.getLong(offset + 2) // task_id
        );
        return entity;
    }
    ...
    protected String getSelectDeep() {
        if (selectDeep == null) {
            ...
            builder.append(" FROM STAFFS_TASKS T");
    ...
    public StaffsTasks loadDeep(Long key) {
        assertSinglePk();
        if (key == null) {
            return null;
        }
    ...
    public List<StaffsTasks> loadAllDeepFromCursor(Cursor cursor) {
        int count = cursor.getCount();
        List<StaffsTasks> list = new ArrayList<StaffsTasks>(count);
    ...
    protected List<StaffsTasks> loadDeepAllAndCloseCursor(Cursor cursor) {
        try {
    ...
    public List<StaffsTasks> queryDeep(String where, String... selectionArg) {
